...
<section class="slider principal">
	<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
	  ...
	  <!-- Wrapper for slides -->
	  <div class="carousel-inner wow fadeIn" role="listbox">
	  ...
	  <a class="left carousel-control" href="#carousel-example-generic" role="button" data-slide="prev">
	    <span class="glyphicon glyphicon-chevron-left" aria-hidden="true"><i class="material-icons">keyboard_arrow_left</i></span>
	    <span class="sr-only">Previous</span>
	  </a>
	  <a class="right carousel-control" href="#carousel-example-generic" role="button" data-slide="next">
	    <span class="glyphicon glyphicon-chevron-right" aria-hidden="true"><i class="material-icons">keyboard_arrow_right</i></span>
	    <span class="sr-only">Next</span>
	  </a>
	</div>
</section>

<section class="numero-actual">
...
<section class="ediciones-fractal">
	<article class="container">
		<h1>Ediciones Fractal</h1>
		<div class="col-sm-12 col-md-6 wow fadeIn" data-wow-delay=".1s">
			<div class="col-xx col-xs-6 col-sm-6 col-md-5"><img src="assets/images/unomasuno.jpg" alt=""></div>
			<div class="col-xx col-xs-6 col-sm-6 col-md-7">
				<h2>Unomasuno</h2>
		...
		<div class="col-sm-12 col-md-6 wow fadeIn" data-wow-delay=".3s">
			<div class="col-xx col-xs-6 col-sm-6 col-md-5"><img src="assets/images/defensas.jpg" alt=""></div>
			<div class="col-xx col-xs-6 col-sm-6 col-md-7">
				<h2>Defensas</h2>
				<h3>Pedro Serrano</h3>
...
<section class="articulos-relevantes">
	<h1>La X y la Y</h1>
	<div class="grid">
					<figure class="effect-oscar wow fadeIn" data-wow-delay=".1s">
						<img src="assets/images/jeanluc.png" alt="img02" />
						<figcaption>
...
<section>
<article class="ciudad-anterior container">
	
		<div class="col-sm-12 col-md-6  laciudad wow fadeIn" data-wow-delay=".3s">
			<h1>
				La ciudad de los libros
			</h1>
			
			<div id="carousel-example-generic2" class="carousel slide libros" data-ride="carousel">
			  <!-- Indicators -->
			  <ol class="carousel-indicators">
		...
		<div class="col-sm-12 col-md-6 numero-anterior wow fadeIn" data-wow-delay=".5s">
			<h1>
				Número anterior
			</h1>
